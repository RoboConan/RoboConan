...
class GladConan(ConanFile):
    ...
    def generate(self):
        ...
        tc.cache_variables["GLAD_SOURCES_DIR"] = self.source_folder
        tc.cache_variables["GLAD_CONAN_LIB_TYPE"] = "SHARED" if self.options.shared else "STATIC"
        tc.cache_variables["GLAD_CONAN_API"] = self._get_api()
