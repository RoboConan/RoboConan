...
class LibXResConan(ConanFile):
    ...
    def build_requirements(self):
        ...
        self.tool_requires("meson/[>=1.3.0 <2]")
    ...
    def package_info(self):
        self.cpp_info.set_property("pkg_config_name", "xres")
        self.cpp_info.set_property("cmake_target_name", "X11::XRes")
