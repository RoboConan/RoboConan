...
class LibXfixesConan(ConanFile):
    ...
    def package_info(self):
        self.cpp_info.set_property("pkg_config_name", "xfixes")
        self.cpp_info.set_property("cmake_target_name", "X11::Xfixes")
        self.cpp_info.libs = ["Xfixes"]
        self.cpp_info.requires = ["libx11::x11", "xorg-proto::xorg-proto"]
