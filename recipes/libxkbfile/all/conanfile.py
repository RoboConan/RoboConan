...
class LibXkbfileConan(ConanFile):
    name = "libxkbfile"
    ...
    def build_requirements(self):
        self.tool_requires("meson/[>=0.57.0 <2]")
    ...
    def package_info(self):
        self.cpp_info.set_property("pkg_config_name", "xkbfile")
        self.cpp_info.set_property("cmake_target_name", "X11::xkbfile")
        self.cpp_info.libs = ["xkbfile"]
        self.cpp_info.requires = ["xorg-proto::xorg-proto", "libx11::x11"]
